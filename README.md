...
برای استفاده از ArvanCloud، ابتدا باید در پنل آروان یک **Machine User** بسازید و دسترسی دامنه‌ها را به آن بدهید:

1. وارد پنل کاربری ArvanCloud شوید.
2. از بخش حساب کاربری / IAM، وارد قسمت **Machine Users** یا کاربران ماشینی شوید.
3. یک Machine User جدید بسازید و برای آن Access Key/API Key ایجاد کنید.
4. در بخش دسترسی‌ها، دامنه‌هایی را که می‌خواهید ربات مدیریت کند انتخاب کنید.
5. برای هر دامنه، نقش‌های مربوط به مدیریت DNS را فعال کنید. برای نمایش و انتخاب دامنه‌ها، در صورت نیاز دسترسی مشاهده/مدیریت دامنه را هم فعال کنید.
6. کلید ساخته‌شده را از طریق اسکریپت نصب در مسیر مدیریت اکانت‌های DNS، به عنوان اکانت ArvanCloud اضافه کنید.

اگر دامنه‌ها داخل ربات نمایش داده نشدند، معمولاً یعنی Machine User به دامنه موردنظر دسترسی نگرفته یا نقش DNS برای آن دامنه فعال نشده است.
